...
public class Example1 {
	...
	public static void main(String[] args) {
		...
		// If you're using windows, you could download winutils from
		// https://github.com/steveloughran/winutils
		System.setProperty("hadoop.home.dir", "D://Hadoop/hadoop-3.0.0");

		// Configure Spark Session
		SparkSession spark = SparkSession.builder().master("local[*]").appName("Example1").getOrCreate();

		// Configure Dataset
		Dataset<Row> dataFrame = spark.read().option("header", "true").csv(dataPath);
